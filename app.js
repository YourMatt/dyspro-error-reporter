...
app.get     ("/api/errors/:environment/:numRecords?", api.error.getForEnvironment);
app.post    ("/api/errors/:environment");
...
app.get     ("/api/monitors/:environment", api.monitor.getAllForEnvironment);
